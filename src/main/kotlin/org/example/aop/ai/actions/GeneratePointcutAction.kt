 ...
 */
class GeneratePointcutAction : AnAction("Generate Pointcut with AI") {
        ...
        ProgressManager.getInstance().run(object : Task.Backgroundable(
            ...
            override fun onSuccess() {
                ...
                WriteCommandAction.runWriteCommandAction(project) {
                    ...
                    document.insertString(offset, "\"$pointcut\"")
                    editor.caretModel.moveToOffset(offset + pointcut.length + 2)
                }
